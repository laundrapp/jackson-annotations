...
@interface ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator ()

- (instancetype __nonnull)initWithIOSClass:(IOSClass *)scope;

@end

inline jlong ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_get_serialVersionUID(void);
#define ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_serialVersionUID 1LL
J2OBJC_STATIC_FIELD_CONSTANT(ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator, serialVersionUID, jlong)

__attribute__((unused)) static void ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_initWithIOSClass_(ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator *self, IOSClass *scope);

__attribute__((unused)) static ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator *new_ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_initWithIOSClass_(IOSClass *scope) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator *create_ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_initWithIOSClass_(IOSClass *scope);
...
@implementation ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype __nonnull)init {
  ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_init(self);
  return self;
}
J2OBJC_IGNORE_DESIGNATED_END

- (instancetype __nonnull)initWithIOSClass:(IOSClass *)scope {
  ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_initWithIOSClass_(self, scope);
  return self;
}
...
- (NSString *)generateIdWithId:(id)forPojo {
  return [((JavaUtilUUID *) nil_chk(JavaUtilUUID_randomUUID())) description];
}
...
- (jboolean)canUseForWithComFasterxmlJacksonAnnotationObjectIdGenerator:(ComFasterxmlJacksonAnnotationObjectIdGenerator *)gen {
  return ([gen isKindOfClass:[ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator class]]);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "serialVersionUID", "J", .constantValue.asLong = ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_serialVersionUID, 0x1a, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LIOSClass;", "(Ljava/lang/Class<*>;)V", "forScope", "(Ljava/lang/Class<*>;)Lcom/fasterxml/jackson/annotation/ObjectIdGenerator<Ljava/lang/String;>;", "newForSerialization", "LNSObject;", "(Ljava/lang/Object;)Lcom/fasterxml/jackson/annotation/ObjectIdGenerator<Ljava/lang/String;>;", "generateId", "key", "canUseFor", "LComFasterxmlJacksonAnnotationObjectIdGenerator;", "(Lcom/fasterxml/jackson/annotation/ObjectIdGenerator<*>;)Z", "LComFasterxmlJacksonAnnotationObjectIdGenerators;", "Lcom/fasterxml/jackson/annotation/ObjectIdGenerators$Base<Ljava/lang/String;>;" };
  static const J2ObjcClassInfo _ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator = { "StringIdGenerator", "com.fasterxml.jackson.annotation", ptrTable, methods, fields, 7, 0x19, 7, 1, 12, -1, -1, 13, -1 };
  return &_ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator;
}

@end

void ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_init(ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator *self) {
  ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_initWithIOSClass_(self, NSObject_class_());
}

ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator *new_ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_init() {
  J2OBJC_NEW_IMPL(ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator, init)
}

ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator *create_ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_init() {
  J2OBJC_CREATE_IMPL(ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator, init)
}

void ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_initWithIOSClass_(ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator *self, IOSClass *scope) {
  ComFasterxmlJacksonAnnotationObjectIdGenerators_Base_initWithIOSClass_(self, NSObject_class_());
}

ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator *new_ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_initWithIOSClass_(IOSClass *scope) {
  J2OBJC_NEW_IMPL(ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator, initWithIOSClass_, scope)
}

ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator *create_ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator_initWithIOSClass_(IOSClass *scope) {
  J2OBJC_CREATE_IMPL(ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator, initWithIOSClass_, scope)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ComFasterxmlJacksonAnnotationObjectIdGenerators_StringIdGenerator)
