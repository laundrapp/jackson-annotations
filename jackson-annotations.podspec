Pod::Spec.new do |s|
  s.name             = "jackson-annotations"
  s.version          = '2.9.3.J2ObjC2.1.1'
  s.author           = { "Ryan Salton" => "ryan.salton@laundrapp.com" }
  s.source           = { :git => "https://github.com/laundrapp/jackson-annotations.git", :tag => "2.9.3.J2ObjC2.1.1" }
  s.summary           = "Converted to Objective-C using J2ObjC."
  s.homepage         = "https://github.com/laundrapp/jackson-annotations.git"
